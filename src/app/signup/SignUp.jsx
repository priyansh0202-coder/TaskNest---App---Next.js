...
const SignUp = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-100 via-white to-blue-100">
            <div className="grid grid-cols-1 md:grid-cols-2 w-11/12 max-w-5xl bg-white rounded-2xl shadow-lg overflow-hidden">
                {/* Left side illustration */}
                <div className="flex justify-center items-center p-8 bg-gradient-to-br from-orange-50 to-blue-50">
                    <Image src={SingUpsvg} alt="Signup illustration" className="w-80 h-80" />
                </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                onChange={handleChange}
                                placeholder="Enter your name"
                                className="w-full text-black px-4 py-2 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:bg-white transition"
                            />
                        </div>
